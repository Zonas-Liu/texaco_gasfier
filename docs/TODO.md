...
| ISS-030 | WDKR 壁面热损失未传入 | 🔴 Critical | main.py 传入 wdkr_func=WDKR |
| ISS-031 | 代码清理与冗余移除 | 🟢 Maintenance | 删除未使用函数、清理导入、更新 .gitignore |
...
- 出口温度: 0.00% 误差 ✅
- 碳转化率: 0.00% 误差 ✅
- 干煤气成分 (O2/CH4/CO/CO2/H2S/H2/N2): 0.00% 误差 ✅
...
- [x] 修复 WDKR 未传入导致的温度/成分偏差 (ISS-030)
- [x] 代码清理：删除 gasifier_simple 等冗余函数、移除未使用导入、更新 .gitignore

**待完成**:
- [ ] 推送本地提交到远程 origin/main
- [ ] 长周期稳定性测试 (300+ 迭代)
- [ ] 不同初始猜测的鲁棒性测试
- [ ] 边界条件变化测试
...
| 2026-06-15 | ISS-030 修复完成，Python/Fortran 结果 0.00% 误差，代码清理 |
| 待完成 | GitHub 推送 |
